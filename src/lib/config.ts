...
export const ORDER_STATUS_TRANSITIONS: Record<OrderStatus, OrderStatus[]> = {
  ...
  [ORDER_STATUS.CUTTING]: [ORDER_STATUS.STITCHING, ORDER_STATUS.READY, ORDER_STATUS.DELIVERED, ORDER_STATUS.CANCELLED],
  [ORDER_STATUS.STITCHING]: [ORDER_STATUS.READY, ORDER_STATUS.CANCELLED],
  [ORDER_STATUS.QC]: [ORDER_STATUS.READY, ORDER_STATUS.DELIVERED, ORDER_STATUS.CANCELLED],
