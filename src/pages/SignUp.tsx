    ...
    >
              ...
              {[
                {
                  ...
                  text: t("auth.instantMeasurement"),
                },
                {
                  icon: <Shield className="h-5 w-5" />,
                  text: t("auth.secureCloud"),
                },
                {
                  icon: <Star className="h-5 w-5" />,
                  text: t("auth.professionalInvoicing"),
                },
              ].map((item, i) => (
      ...
      <div className="flex-1 flex flex-col justify-center px-6 sm:px-12 lg:px-24 py-12 bg-[#FDFCF9] relative overflow-y-auto">
        <div className="max-w-md w-full mx-auto">
          <Link
            to="/"
            className="flex items-center gap-2 mb-8 text-slate-500 hover:text-slate-900 transition-colors w-fit"
          >
            {isRTL ? (
              ...
              {step === 1 ? (
                ...
                >
                  ...
                  <div className="flex flex-col items-center justify-center mb-6">
                    <label className="relative cursor-pointer group">
                      <input
                        ...
                        onChange={(e) =>
                          e.target.files?.[0] &&
                          profileUpload.selectFile(e.target.files[0])
                        }
                      />
                    ...
                    {profileUpload.uploading && (
                      <div className="w-24 h-1.5 bg-slate-200 rounded-full mt-3 overflow-hidden">
                        <div
                          ...
                          style={{ width: `${profileUpload.progress}%` }}
                        ></div>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="space-y-2">
                    <label
                      className={cn(
                        "text-sm font-bold text-slate-700 block",
                        isRTL ? "mr-1" : "ml-1",
                      )}
                    >
                    ...
                    <div className="relative">
                      <User
                        className={cn(
                          "absolute top-1/2 -translate-y-1/2 h-5 w-5 text-slate-400 z-10",
                      ...
                      <Input
                        ...
                        className={cn(
                          "h-14 rounded-2xl border-none bg-gray-100 shadow-neu-pressed-sm focus:ring-2 focus:ring-brand-primary/20 transition-all text-lg",
                  ...
                  <Button
                    ...
                    onClick={handleNext}
                    className={cn(
                      "w-full h-16 rounded-2xl bg-brand-primary hover:bg-brand-primary/90 text-white font-bold text-lg shadow-2xl shadow-brand-primary/20 transition-all active:scale-95 mt-4 flex items-center justify-center gap-2",
                ...
                >
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className={cn(
                          "h-14 rounded-2xl border-slate-200 bg-white focus:ring-brand-primary focus:border-brand-primary transition-all text-lg",
                          isRTL ? "pr-12 text-right" : "pl-12",
                        )}
                      />
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <input
                        ...
                        onChange={(e) =>
                          e.target.files?.[0] &&
                          logoUpload.selectFile(e.target.files[0])
                        }
                      />
                      {logoUpload.preview ? (
                        ...
                        <label
                          htmlFor="logo-upload"
                          className="w-full h-32 border-none shadow-neu-sm rounded-2xl flex flex-col items-center justify-center cursor-pointer bg-gray-100 hover:shadow-neu-pressed-sm transition-all group"
                        >
                  ...
                  <div className="flex gap-3 pt-4">
                    ...
                    <Button
                      ...
                      disabled={isLoading || isUploading}
                      className={cn(
                        "flex-1 h-16 rounded-2xl bg-brand-primary hover:bg-brand-primary/90 text-white font-bold text-lg shadow-2xl shadow-brand-primary/20 transition-all active:scale-95 flex items-center justify-center gap-2",
                        isRTL && "flex-row-reverse",
                      )}
                    >
