      ...
      <header className="fixed top-0 w-full z-50 bg-white/95 dark:bg-slate-900/95 backdrop-blur-sm border-b border-slate-200 dark:border-slate-800 shadow-sm">
        <div className="flex items-center justify-between px-6 md:px-12 py-4 max-w-7xl mx-auto">
          <div className="flex items-center gap-2">
            <img src="/icon-192x192.svg" alt="LoopTailor Logo" className="w-8 h-8 md:w-10 md:h-10 rounded-lg shadow-sm" />
            <span className="text-2xl font-bold tracking-tight text-[#22C55E] font-plus-jakarta">LoopTailor</span>
          </div>
      ...
      <main className="pt-24 overflow-x-hidden">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight text-on-surface text-h1 leading-tight">
                Precision <span className="text-[#22C55E]">Tailoring</span>, Managed Smarter
              </h1>
            ...
            <div className="flex-1 space-y-6">
              ...
              <div className="space-y-4 pt-4">
                <div className="flex items-center justify-between py-3 border-b border-dotted border-outline">
                  ...
                  <span className="text-[#22C55E] font-bold text-xl">42.5 in</span>
                </div>
                <div className="flex items-center justify-between py-3 border-b border-dotted border-outline">
                  <span className="text-on-surface-variant font-medium">Shoulder Width</span>
                  <span className="text-[#22C55E] font-bold text-xl">18.2 in</span>
                </div>
                <div className="flex items-center justify-between py-3 border-b border-dotted border-outline">
                  <span className="text-on-surface-variant font-medium">Sleeve Length</span>
                  <span className="text-[#22C55E] font-bold text-xl">25.0 in</span>
                </div>
              </div>
            </div>
            <div className="flex-1 w-full">
              <div className="relative">
                <div className="absolute inset-0 bg-[#22C55E]/20 rounded-[40px] rotate-3 -z-10"></div>
        ...
        <section className="py-24 bg-surface-container-high relative overflow-hidden">
          <div className="max-w-4xl mx-auto px-6 text-center space-y-8">
            <span className="material-symbols-outlined text-[#22C55E] text-6xl opacity-30" style={{fontVariationSettings: "'FILL' 1"}}>format_quote</span>
        ...
        <section className="py-24 px-6">
          <div className="max-w-5xl mx-auto bg-on-surface text-surface-container-lowest rounded-[40px] p-12 md:p-24 text-center space-y-10 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-64 h-64 bg-[#22C55E]/20 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"></div>
