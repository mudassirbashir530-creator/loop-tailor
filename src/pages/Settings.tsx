  ...
  return (
    <div className={cn("w-full max-w-4xl mx-auto pb-32", isRTL && "font-urdu")} dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <div className="px-4 sm:px-6 py-6 space-y-8">
        ...
        >
          <div className="p-5 sm:p-6 border-b border-outline-variant bg-surface-container-lowest">
            <h2 className="text-lg font-medium text-error flex items-center gap-3">
          ...
          <div className="p-5 sm:p-6 space-y-4">
            <p className="text-sm text-on-surface-variant">
              If your app is having loading issues or if you want to clear all information or data saved on your mobile / browser local storage, you can purge the cache. Since our app is securely attached to Firebase and MongoDB, none of your actual cloud data will be lost.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              <button
                ...
                onClick={() => {
                  ...
                  toast.success("Successfully cleared all local mobile storage and cache. Reloading...");
                  setTimeout(() => {
                    window.location.reload();
                  }, 1500);
                }}
                className="flex-1 h-12 bg-error/10 text-error border border-error/20 rounded-xl flex items-center justify-center gap-2 font-medium hover:bg-error/20 transition-colors shadow-soft"
              >
                <Trash2 className="w-4 h-4" />
