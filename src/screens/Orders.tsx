...
export default function Orders() {
  ...
  const handleWhatsAppShare = () => {
    ...
    const message = `Hello ${selectedOrder.customerName},\n\n` +
      `Your order for ${selectedOrder.clothingType} is currently in *${selectedOrder.status.toUpperCase()}* status.\n\n` +
      `• *Total Price:* ${formatCurrency(selectedOrder.price)}\n` +
      `• *Remaining Balance:* ${formatCurrency(selectedOrder.remainingPayment)}\n` +
      `• *Delivery Expected:* ${formatDate(selectedOrder.deliveryDate)}\n\n` +
